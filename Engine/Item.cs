...
// 7/6/2017 - Bug 6 - Renaming the Object class to Item... and thus this file from Object.cs to
//                    Item.cs.
// 
...
namespace Engine
{
    ...
    public class Item : HasInventory
    {
...
//            if ((hiOwner != null) && (hiOwner.GetType() == typeof(Engine.Object)))
            if ((hiOwner != null) && (hiOwner is Item))
    ...
    [DataContractAttribute(IsReference=true)]
    public class RecipeObject : Item
    {
    ...
    [DataContractAttribute(IsReference = true)]
    public class FirePitsObject : Item
    {
    ...
    [DataContractAttribute(IsReference = true)]
    public class FoodStoresObject : Item
    {
    ...
    [DataContractAttribute(IsReference = true)]
    public class LeaderObject : Item
    {
